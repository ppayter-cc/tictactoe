...
def current_player():
    global z
    if z == 0:
        return screen.addstr(4, 10, playernames[0] + " is next!" + " "*30)  # whitespaces to overwrite unneccessary characters if a name is longer than the other
    elif z == 1:
        return screen.addstr(4, 10, playernames[1] + " is next!" + " "*30)
...
def winning():  # whether one of the players won, prints this text
    if winner1():
        screen.addstr(4, 10, playernames[0] + " won!" + " "*30)
    elif winner2():
        screen.addstr(4, 10, playernames[1] + " won!" + " "*30)
    return()
...
screen.addstr(0, 0, "Use the numpad keys to place 'X' and 'O', press 'q' to quit or press 'r' to restart!")
screen.addstr(4, 10, playernames[0] + " is next!" + " "*30)
...
while True:
    ...
    if c == ord('q'):  # if 'q' pressed the game exits
        ...
        screen.addstr(0, 0, "Use number keys to place 'X' and 'O', press 'q' to quit or press 'r' to restart!")
        board = [' '] * 10
        z = 0
